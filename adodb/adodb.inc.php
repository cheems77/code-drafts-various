 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
	...
	if (!$ADODB_EXTENSION || ADODB_EXTENSION < 4.0) {
		...
		define('ADODB_BAD_RS','<span class="display: block;">
...
*/
	...
	var $database = 'ccweb';			/// Name of database to be used.	
	...
	*/
	...
	function Insert_ID($table='',$column='')
	{
		...
		if ($this->debug) {
			ADOConnection::outp( '<span class="display: block;">
Insert_ID error
<br />
</span>');
			adodb_backtrace();
	...
	*/ 
	function Affected_Rows()
	{
		...
		if ($this->debug) ADOConnection::outp( '<span class="display: block;">
Affected_Rows error
<br />
</span>',false);
		return false;
